...
public class TruckFeignFallback implements TruckFeign {
    ...
    public TruckDto saveTruck(TruckDto dto) {
        log.error("远程调用 pd-base 失败: saveTruck({}), 返回null", dto);
        return null;
    }
    ...
    public PageResponse<TruckDto> findByPage(Integer page, Integer pageSize, String truckTypeId, String licensePlate, String fleetId) {
        log.error("远程调用 pd-base 失败: findByPage(page={}, pageSize={}, truckTypeId={}, licensePlate={}, fleetId={}), 返回空分页", page, pageSize, truckTypeId, licensePlate, fleetId);
    ...
    public List<TruckDto> findAll(List<String> ids, String fleetId) {
        log.error("远程调用 pd-base 失败: findAll(ids={}, fleetId={}), 返回空列表", ids, fleetId);
    ...
    public Integer count(String fleetId) {
        log.error("远程调用 pd-base 失败: count(fleetId={}), 返回0", fleetId);
        return 0;
    }
